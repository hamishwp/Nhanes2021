...
transformed parameters {
  ...
  xhat_v[3] =  (log_sum_exp(tauis[,3]*beta[6]) - log(N)) ./beta[6];
  xhat_v[4] =  (log_sum_exp(tauis[,4]*beta[7]) - log(N)) ./beta[7];
  
  linnie=linear_predictor(FRS, FRSc, abs_Delta_i, xhat_D, tauis, xhat_v, beta);
