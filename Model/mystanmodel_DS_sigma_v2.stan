...
transformed parameters {
  ...
  // xhat_v[3] =  (log_sum_exp(sigmais[,3]*beta[7]) - log(N)) ./beta[7];
  // xhat_v[4] =  (log_sum_exp(sigmais[,4]*beta[8]) - log(N)) ./beta[8];
  
  linnie=linear_predictor(M_i, xhat_M, abs_Delta_i, xhat_D, sigmais, xhat_v, beta);
