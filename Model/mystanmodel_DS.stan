...
real log_h(real T,
         vector M, vector m1 , vector Delta, vector m2, vector tauis, vector mean_tauis,
...
real surv_dens_lpdf(vector T_and_delta,
                    vector M, vector m1 , vector Delta, vector m2,
    ...
    return (delta * log_h(T, M, m1, Delta, m2, tauis, mean_tauis, beta,  gompertz, age))
                 -    H_t(T, M, m1, Delta, m2, tauis, mean_tauis, beta,  gompertz, age) ;
...
model {
  ...
  for(i in 1:N){
    ...
    Surv_T_and_delta[i] ~ surv_dens(M_i[i], xhat_M,
