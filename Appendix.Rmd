...
load(S1)
```
```{r process, include=FALSE,message=FALSE,warning=FALSE}
N=dim(nhanesA)[1]
k=3
...
To finish this section, we include a table of the empirical Bayes priors, shown in table \ref{tab:empests}
