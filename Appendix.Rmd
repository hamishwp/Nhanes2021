...
```
In Figure \ref{fig:ternaryPlot}, we show a ternary plot of the normalized frequencies of the three possible positions of the measurement that is unique, with one point for each examiner, blocked by place and type.
