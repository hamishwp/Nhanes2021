...
CDemog <- xlsx::read.xlsx("Concordance_Indices.xlsx",sheetIndex=1)
Concy <- xlsx::read.xlsx("Concordance_Indices.xlsx",sheetIndex=2)
...
kable(Concy,escape = F,booktabs = T,format = "latex")
...
kable(CDemog,escape = F,booktabs = T,format = "latex")
