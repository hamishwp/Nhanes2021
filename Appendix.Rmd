...
![Figure A.1: an illustration of the DAG of the mean blood pressure-based model presented in this article.](../DAG_Mean.png)
![Figure A.2: an illustration of the DAG of the FRS-based model presented in this article.](../DAG_FRS.png)
...
![Figure A.3: illustration of the convergence of the centering parameters of the model](../Plots/xhat/RMSE-Linpred_Convergence.png)
...
![Figure A.4: Violin plots of the normalised $\beta$ parameters of the different models.](../Plots/beta/Beta_parameter_normalised.png)
...
![Figure A.5: Violin plots of the normalised B parameter (from the Gompertz equation) of the different models.](../Plots/gompertz/B_parameter.png)
...
![Figure A.6: Violin plots of the normalised $\theta$ parameter (from the Gompertz equation) of the different models.](../Plots/gompertz/theta_parameter.png)
...
![Figure A.7: Predicted cumulative hazard against cumulative number of deaths in the population, ordered by the age of the individual.](../Plots/Survival/redlinpred_Cumulative_haz-death_age.png)
