...
\centering
\includegraphics{NHANES-BP-Appendix_files/figure-latex/SD-mean-1.pdf}
\caption{\label{fig:SD-mean}2D density plot of individual mean BP against individual SD of BP}
\end{figure}
...
\cellcolor{gray!6}{\hspace{1em}$m_M$} & \cellcolor{gray!6}{123.3} & \cellcolor{gray!6}{123.3} & \cellcolor{gray!6}{2.24e-05} & \cellcolor{gray!6}{72.33} & \cellcolor{gray!6}{72.31} & \cellcolor{gray!6}{0.0002955}\\
\hspace{1em}$m_\Delta$ & 1.332 & 1.349 & -0.01244 & 1.114 & 1.1 & 0.01326\\
\cellcolor{gray!6}{\hspace{1em}$\sigma^2_M$} & \cellcolor{gray!6}{376} & \cellcolor{gray!6}{376.8} & \cellcolor{gray!6}{-0.002022} & \cellcolor{gray!6}{104.1} & \cellcolor{gray!6}{104} & \cellcolor{gray!6}{0.001289}\\
\hspace{1em}$\sigma^2_\Delta$ & 46.36 & 46.42 & -0.001326 & 21.92 & 21.9 & 0.000857\\
\cellcolor{gray!6}{\hspace{1em}$\alpha_H$} & \cellcolor{gray!6}{2.146} & \cellcolor{gray!6}{2.158} & \cellcolor{gray!6}{-0.005432} & \cellcolor{gray!6}{2.365} & \cellcolor{gray!6}{2.322} & \cellcolor{gray!6}{0.01864}\\
\hspace{1em}$\theta_H$ & 0.1501 & 0.1496 & 0.003854 & 0.1933 & 0.1945 & -0.005856\\
\cellcolor{gray!6}{\hspace{1em}$\alpha_C$} & \cellcolor{gray!6}{2.576} & \cellcolor{gray!6}{2.569} & \cellcolor{gray!6}{0.002662} & \cellcolor{gray!6}{2.727} & \cellcolor{gray!6}{2.756} & \cellcolor{gray!6}{-0.01057}\\
\hspace{1em}$\theta_C$ & 0.07507 & 0.07515 & -0.001023 & 0.1097 & 0.1093 & 0.003751\\
\addlinespace[0.3em]
\multicolumn{7}{l}{\textbf{Parameter SE estimates}}\\
\cellcolor{gray!6}{\hspace{1em}$m_M$} & \cellcolor{gray!6}{0.1608} & \cellcolor{gray!6}{0.1425} & \cellcolor{gray!6}{0.1282} & \cellcolor{gray!6}{0.08507} & \cellcolor{gray!6}{0.1073} & \cellcolor{gray!6}{-0.2073}\\
\hspace{1em}$m_\Delta$ & 0.05795 & 0.06752 & -0.1417 & 0.04036 & 0.03555 & 0.1353\\
\cellcolor{gray!6}{\hspace{1em}$\sigma^2_M$} & \cellcolor{gray!6}{4.394} & \cellcolor{gray!6}{4.34} & \cellcolor{gray!6}{0.0125} & \cellcolor{gray!6}{1.218} & \cellcolor{gray!6}{1.511} & \cellcolor{gray!6}{-0.1937}\\
\hspace{1em}$\sigma^2_\Delta$ & 0.551 & 0.6702 & -0.1778 & 0.2651 & 0.2495 & 0.06249\\
\cellcolor{gray!6}{\hspace{1em}$\alpha_H$} & \cellcolor{gray!6}{0.05593} & \cellcolor{gray!6}{0.0723} & \cellcolor{gray!6}{-0.2264} & \cellcolor{gray!6}{0.06586} & \cellcolor{gray!6}{0.0524} & \cellcolor{gray!6}{0.257}\\
\hspace{1em}$\theta_H$ & 0.002128 & 0.002877 & -0.2605 & 0.002697 & 0.001951 & 0.3823\\
\cellcolor{gray!6}{\hspace{1em}$\alpha_C$} & \cellcolor{gray!6}{0.07608} & \cellcolor{gray!6}{0.04467} & \cellcolor{gray!6}{0.7034} & \cellcolor{gray!6}{0.08412} & \cellcolor{gray!6}{0.07422} & \cellcolor{gray!6}{0.1334}\\
\hspace{1em}$\theta_C$ & 0.001033 & 0.001119 & -0.07645 & 0.0015 & 0.001246 & 0.2041\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
D i D & -0.053 & \(-0.067,-0.039\)\\
D i S & 0.130 & \(0.096,0.16\)\\
sigma C D & 0.023 & \(0.012,0.035\)\\
sigma C S & -0.021 & \(-0.052,0.0098\)\\
sigma H D & -0.075 & \(-0.12,-0.032\)\\
\addlinespace
sigma H S & -0.026 & \(-0.06,0.0076\)\\
\bottomrule
\end{tabular}
\end{table}
...
Covariate & Beta Normalised (IQR) & Range\\
\midrule
D i D & -0.03400 & \(-0.042,-0.026\)\\
D i S & 0.07800 & \(0.059,0.096\)\\
sigma C D & 0.02400 & \(0.017,0.03\)\\
sigma C S & -0.01600 & \(-0.032,-7.6e-05\)\\
sigma H D & -0.02800 & \(-0.05,-0.0066\)\\
\addlinespace
sigma H S & 0.00066 & \(-0.015,0.017\)\\
\bottomrule
\end{tabular}
\end{table}
...
Covariate & Beta Normalised (IQR) & Range\\
\midrule
D i D & -0.0150 & \(-0.034,0.0045\)\\
D i S & 0.1200 & \(0.067,0.17\)\\
sigma C D & 0.0260 & \(0.01,0.042\)\\
sigma C S & -0.0470 & \(-0.096,0.0021\)\\
sigma H D & 0.0046 & \(-0.056,0.065\)\\
\addlinespace
sigma H S & 0.0600 & \(0.012,0.11\)\\
\bottomrule
\end{tabular}
\end{table}
...
Covariate & Beta Normalised (IQR) & Range\\
\midrule
D i D & -0.013 & \(-0.023,-0.0025\)\\
D i S & 0.073 & \(0.047,0.099\)\\
sigma C D & 0.024 & \(0.015,0.032\)\\
sigma C S & -0.023 & \(-0.046,0.00067\)\\
sigma H D & 0.010 & \(-0.018,0.039\)\\
\addlinespace
sigma H S & 0.032 & \(0.0055,0.058\)\\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
FRS.1998 & 0.5191881 & <0.001 & (0.36,0.67)\\
D i S & 0.1127844 & <0.001 & (0.05,0.18)\\
D i D & 0.1081153 & 0.0033 & (0.035,0.18)\\
sigma C S & 0.0186258 & 0.59 & (-0.05,0.087)\\
sigma H S & 0.0542982 & 0.13 & (-0.015,0.12)\\
\addlinespace
sigma C D & 0.0268981 & 0.45 & (-0.042,0.096)\\
sigma H D & 0.0299251 & 0.41 & (-0.043,0.1)\\
survival::strata(race)race=1 & NA & 0.0017 & (NA,NA)\\
survival::strata(race)race=2 & NA & 0.11 & (NA,NA)\\
survival::strata(female)female=1 & NA & <0.001 & (NA,NA)\\
\bottomrule
\end{tabular}
\end{table}
...
Covariate & Beta Normalised & P-Value & Range\\
\midrule
FRS.1998 & 0.2022811 & <0.001 & (0.13,0.28)\\
D i S & 0.0812047 & <0.001 & (0.05,0.12)\\
D i D & 0.0730509 & <0.001 & (0.035,0.11)\\
sigma C S & 0.0096854 & 0.59 & (-0.025,0.045)\\
sigma H S & 0.0144795 & 0.43 & (-0.022,0.05)\\
\addlinespace
sigma C D & 0.0230555 & 0.21 & (-0.013,0.058)\\
sigma H D & 0.0142975 & 0.47 & (-0.025,0.053)\\
survival::strata(race)race=1 & NA & 0.019 & (NA,NA)\\
survival::strata(race)race=2 & NA & <0.001 & (NA,NA)\\
survival::strata(female)female=1 & NA & <0.001 & (NA,NA)\\
\bottomrule
\end{tabular}
\end{table}
...
Covariate & Beta Normalised & P-Value & Range\\
\midrule
M i S & 0.3117548 & <0.001 & (0.25,0.37)\\
M i D & -0.0998613 & 0.0021 & (-0.16,-0.036)\\
D i S & 0.0653030 & 0.003 & (0.021,0.11)\\
D i D & 0.0561367 & 0.033 & (0.0044,0.11)\\
sigma C S & -0.0097834 & 0.67 & (-0.054,0.036)\\
\addlinespace
sigma H S & -0.0142106 & 0.54 & (-0.06,0.03)\\
sigma C D & -0.0286500 & 0.28 & (-0.08,0.023)\\
sigma H D & 0.0237782 & 0.38 & (-0.031,0.078)\\
survival::strata(race)race=1 & NA & 0.93 & (NA,NA)\\
survival::strata(race)race=2 & NA & 0.0079 & (NA,NA)\\
\addlinespace
survival::strata(female)female=1 & NA & <0.001 & (NA,NA)\\
\bottomrule
\end{tabular}
...
Covariate & Beta Normalised & P-Value & Range\\
\midrule
M i S & 0.1714651 & <0.001 & (0.13,0.21)\\
M i D & -0.0535339 & 0.0035 & (-0.089,-0.018)\\
D i S & 0.0447792 & <0.001 & (0.02,0.07)\\
D i D & 0.0561367 & <0.001 & (0.026,0.083)\\
sigma C S & -0.0087536 & 0.5 & (-0.033,0.017)\\
\addlinespace
sigma H S & -0.0030022 & 0.82 & (-0.028,0.022)\\
sigma C D & -0.0061393 & 0.67 & (-0.035,0.023)\\
sigma H D & 0.0146066 & 0.34 & (-0.015,0.044)\\
survival::strata(race)race=1 & NA & 0.29 & (NA,NA)\\
survival::strata(race)race=2 & NA & 0.001 & (NA,NA)\\
\addlinespace
survival::strata(female)female=1 & NA & <0.001 & (NA,NA)\\
\bottomrule
...
\leavevmode\vadjust pre{\hypertarget{ref-CDCBP}{}}%
